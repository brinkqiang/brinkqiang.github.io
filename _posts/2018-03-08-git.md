...
## 从main或者master分支切换 到指定版本后 子模块 可能还是使用的 main或者master分支 这点要特别注意
```
git checkout -b new_branch v1.68.2
git submodule update --init --recursive
```



# 10. 本地签入合并冲突提示: Please, commit your changes or stash them before you can merge.
```
git stash
git pull
git stash pop
