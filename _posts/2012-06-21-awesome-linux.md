...
- [Learning Resources](#learning-resources)
  - [Books](#books)
    - [The Linux Command Line [4.34] [FREE]](#the-linux-command-line-434-free)
    - [The Debian Administrator's Handbook, Debian Wheezy from Discovery to Mastery [4.8] [FREE]](#the-debian-administrators-handbook-debian-wheezy-from-discovery-to-mastery-48-free)
    - [Bash Shell Scripting [FREE]](#bash-shell-scripting-free)
  - [Courses](#courses)
    - [Introduction to Linux (LFS101x-1) [Free]](#introduction-to-linux-lfs101x-1-free)
    - [Linux Alternatives to Windows Applications [Free]](#linux-alternatives-to-windows-applications-free)
  - [Bash Learning Resources](#bash-learning-resources)
...
- [Applications](#applications)
  - [GUI-based Applications](#gui-based-applications)
    ...
    - [Package management and creation tools](#package-management-and-creation-tools)
  - [Console-based Applications and Tools](#console-based-applications-and-tools)
- [Useful Websites](#useful-websites)
    - [Compute Freely](#compute-freely)
    - [AlternativeTo](#alternativeto)
    - [Linux Foundation](#linux-foundation)
    - [Linux.com](#linuxcom)
    - [Linux.org](#linuxorg)
    - [Kernel.org](#kernelorg)
    - [Opensource.com](#opensourcecom)
    - [Linux.die](#linuxdie)
